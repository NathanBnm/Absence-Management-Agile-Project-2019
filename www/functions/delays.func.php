...
function list_teacher_delays()
{
    ...
    $sql = "SELECT absence.SIG_COMMENTAIRE, absence.SIG_MOTIF, absence.SIG_ETAT, etu.UTI_PRENOM, etu.UTI_NOM, etu.UTI_IDENTIFIANT, cours.COU_MODULE, DATE_FORMAT(SIG_DATE, 'Le %d/%m/%Y à %H:%i') AS SIG_DATE, SIG_TRAITE, COU_TYPE, SIG_ETAT, SIG_CODE, COU_CONTROLE
...
function list_students_delays()
{
    ...
    $u = [
        ...
        etu1.UTI_PRENOM, etu1.UTI_NOM, etu1.UTI_IDENTIFIANT, COU_CONTROLE
