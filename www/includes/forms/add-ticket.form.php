<form id="add-ticket" method="POST">
    <div class="field is-horizontal">
        ...
        <div class="field-label">
            <div class="control">
                <div class="select ">
                    <select id="module" name="module" value="<?php if (isset($_POST['module'])) {
                                                                    echo $_POST['module'];
                                                                } ?>">
                        <?php
    ...
    <div class="field is-horizontal">
        ...
        <div class="field-label">
            <div class="control">
                <div class="select ">
                    <select id="typecourse" name="typecourse" value="<?php if (isset($_POST['typecourse'])) {
                                                                            echo $_POST['typecourse'];
                                                                        } ?>">
        ...
        <div class="field-label is-normal">
            <div class="control">
                <label class="checkbox">
                    <input type="checkbox" id="controle" name="controle" value="<?php if (isset($_POST['controle'])) {
                                                                                    echo $_POST['controle'];
                                                                                } ?>">
                </label>
            </div>
    ...
    <div class="field is-horizontal">
        ...
        <div class="field-label">
            <div class="field">
                <div class="control">
                    <input class="input" type="text" placeholder="ex: 21801010" id="etupass" name="etupass" value="<?php if (isset($_POST['etupass'])) {
                                                                                                                        echo $_POST['etupass'];
                                                                                                                    } ?>">
                </div>
            </div>
